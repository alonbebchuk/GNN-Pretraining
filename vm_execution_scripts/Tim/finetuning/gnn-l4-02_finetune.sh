#!/bin/bash
# Tim's VM2 (gnn-l4-02) - Finetuning Script
# Domains: PTC_MR (54 experiments: 2 strategies × 9 schemes × 3 seeds)

set -e
echo "=== Tim VM2 (gnn-l4-02) - Finetuning Phase ==="
echo "Running: PTC_MR domain (54 experiments)"
...
echo "Starting PTC_MR finetuning experiments..."
python run_finetune.py --domain_sweep PTC_MR

echo "=== Tim VM2 Finetuning Complete ==="
echo "End time: $(date)"
