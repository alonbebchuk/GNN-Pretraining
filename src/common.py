...
PRETRAIN_PATIENCE_FRACTION = 0.25
PRETRAIN_PATIENCE_STEPS_MULTI_DOMAIN = int(PRETRAIN_PATIENCE_FRACTION * PRETRAIN_MAX_STEPS_MULTI_DOMAIN)   # ~3847 steps
PRETRAIN_PATIENCE_STEPS_SINGLE_DOMAIN = int(PRETRAIN_PATIENCE_FRACTION * PRETRAIN_MAX_STEPS_SINGLE_DOMAIN) # ~143 steps

PRETRAIN_WARMUP_FRACTION = 0.1
PRETRAIN_WARMUP_STEPS_MULTI_DOMAIN = int(PRETRAIN_WARMUP_FRACTION * PRETRAIN_MAX_STEPS_MULTI_DOMAIN)   # ~1539 steps
PRETRAIN_WARMUP_STEPS_SINGLE_DOMAIN = int(PRETRAIN_WARMUP_FRACTION * PRETRAIN_MAX_STEPS_SINGLE_DOMAIN)  # ~57 steps

PRETRAIN_LOG_FRACTION = 0.25
PRETRAIN_LOG_EVERY_STEPS_MULTI_DOMAIN = int(PRETRAIN_LOG_FRACTION * STEPS_PER_EPOCH_MULTI_DOMAIN)   # Every ~0.25 epochs
PRETRAIN_LOG_EVERY_STEPS_SINGLE_DOMAIN = int(PRETRAIN_LOG_FRACTION * STEPS_PER_EPOCH_SINGLE_DOMAIN) # Every ~0.25 epochs
